...
if (d1>100 & d2>100 & d3>100 & d4>100){
 ...
 else if((d1>100 & d2>100 & d3>100)|(d1>100 & d3>100 & d4>100)|(d2>100 & d3>100 & d4>100)|(d4>100 & d1>100 & d2>100))
  {
  lcd.setCursor(0,0);
  ...
  lcd.setCursor(0,1);
   ...
   else if(d1>100 & d3>100 & d4>100)
    lcd.print("Slot 1 & 3 & 4 Free");
     
   else if(d2>100 & d3>100 & d4>100)
    lcd.print("Slot 2 & 3 & 4 Free");
  
   else
    lcd.print("Slot 4 & 1 & 2 Free");
  delay(500);
  }
 
  
  
else if((d1>100 & d2>100)|(d2>100 & d3>100)|(d3>100 & d4>100)|(d4>100 & d1>100)|(d2>100 & d4>100)|(d1>100 & d3>100))
  {
  lcd.setCursor(0,0);
  ...
  lcd.setCursor(0,1);
    ...
    lcd.print("Slot 1 & 3 Free");
        ...
        else if(d3>100 & d4>100)
    lcd.print("Slot 1 & 3 Free");
      
        else if(d1>100 & d1>100)
    lcd.print("Slot 1 & 3 Free");
      
        else if(d2>100 & d4>100)
    lcd.print("Slot 1 & 3 Free");
  ...
  delay(500);
   ...
   else if((d1>100) |(d2>100) | (d3>100)|(d4>100))
  {
  lcd.setCursor(0,0);
  lcd.print("1 Slots Free");
  lcd.setCursor(0,1);
